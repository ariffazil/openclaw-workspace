...
Files updated:
- `aclip_cai/embeddings/__init__.py` → BAAI/bge-m3
- `aaa_mcp/vault/precedent_memory.py` → 768-dim, multilingual
- `arifos_aaa_mcp/server.py` → 768-dim
- `scripts/*` → BAAI/bge-m3
...
### New Files
- `aaa_mcp/vault/precedent_memory.py` — Constitutional precedent engine
...
- `aclip_cai/embeddings/__init__.py` — Model change
- `arifos_aaa_mcp/server.py` — Dimension update
- `aaa_mcp/tools/vault_seal.py` — Precedent embedding wired
