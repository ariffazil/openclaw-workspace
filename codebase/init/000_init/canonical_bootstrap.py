...
class CanonicalConfigLoader:
    ...
    def _find_config_path(self) -> str:
        ...
        search_paths = [
            ...
            "config/canonical_bootstrap.json",
...
class CanonicalFetchEngine:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.cache_dir = Path(config.get("fallback", {}).get("cache_dir", ".cache/arifos/canonical"))
    ...
    async def _fetch_url(self, source_id: str, band: str, url: str, timeout: int) -> CanonicalSourceResult:
...
class CanonicalBootstrap:
    ...
    async def initialize(
        ...
        if tri_witness_sync:
            ...
            # Fallback to local
            return self._local_fallback(session_id, scar_weight, "Tri-Witness failed, using local fallback")
    ...
    def _local_fallback(self, session_id: str, scar_weight: float, reason: str) -> CanonicalBootstrapResult:
