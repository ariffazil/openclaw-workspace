...
async def verify_f2():
    ...
    ctx_fact = {"query": "What is the capital of France?", "entropy_delta": -0.1, "energy_efficiency": 0.1, "truth_score": 0.995}
...
async def verify_f6():
    ...
    print(f"Social Scope (0.5): {res_social.passed} (Score: {res_social.score}) - {res_social.reason}")
    ...
    print(f"Ops Scope (0.5): {res_ops.passed} (Score: {res_social.score} -> {res_ops.score}) - {res_ops.reason}")
