...
async def anchor(
    ...
    """
    result = await _call_tool("anchor", {
        "query": query,
        "actor_id": actor_id,
...
async def reason(
    ...
    """
    result = await _call_tool("reason", {
        "query": query,
...
async def integrate(
    ...
    """
    result = await _call_tool("integrate", {
        "query": query,
        "session_id": session_id,
...
async def respond(
    ...
    """
    result = await _call_tool("respond", {
        "session_id": session_id,
...
async def validate(
    ...
    """
    result = await _call_tool("validate", {
        "session_id": session_id,
