...
def test_threshold_boundary_49_chars():
    ...
    result = validate_response_full(output_text=output_100, input_text=input_49)
...
def test_threshold_boundary_50_chars():
    ...
    result = validate_response_full(output_text=output_100, input_text=input_50)
...
def test_longer_text_positive_clarity():
    ...
    result = validate_response_full(output_text=structured_output, input_text=verbose_input)
...
def test_longer_text_repetitive_input():
    ...
    result = validate_response_full(output_text=concise, input_text=repetitive)
...
def test_very_long_texts():
    ...
    result = validate_response_full(output_text=long_output, input_text=long_input)
...
def test_edge_case_empty_output():
    ...
    result = validate_response_full(output_text="", input_text="What is the capital of France?")
...
def test_edge_case_empty_input():
    ...
    result = validate_response_full(output_text="The sky is blue.", input_text="")
...
def test_edge_case_very_long_input():
    ...
    long_input = "a" * 10000
    result = validate_response_full(
        output_text="Acknowledged. Processing complete.", input_text=long_input
    )
...
def test_edge_case_identical_input_output():
    ...
    result = validate_response_full(output_text=identical_text, input_text=identical_text)
...
def test_unverifiable_input_text_none():
    ...
    result = validate_response_full(output_text="The sky is blue.", input_text=None)
