...
def create_apex_manifesto_pdf():
    ...
    subtitle = Paragraph(
        "The Strange Loop Architecture: 99 Theories → 13 Floors → Emergence → Validation",
        normal_style,
    )
    ...
    version_info = Paragraph(
        "<b>Version 1.0<br/>Publication Date: February 2026<br/>Author: arifOS Constitutional AI Governance Framework</b>",
        normal_style,
    )
    ...
    story.append(
        Paragraph("<b>1.1 Auto-Emergence of Constitutional Properties</b>", heading2_style)
    )
