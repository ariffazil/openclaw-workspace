...
def calculate_relevance(query: str, title: str, snippet: str, url: str) -> float:
    ...
    stop_words = {"the", "a", "an", "is", "are", "was", "were", "be", "been",
                  ...
                  "its", "our", "their", "what", "which", "who", "whom", "this",
    ...
    credible_domains = [
        ".edu", ".gov", "wikipedia.org", "britannica.com",
...
async def brave_search(query: str, count: int = 5, original_query: str = None) -> List[EvidenceArtifact]:
    """
