...
STAGE_ENUM = {"type": "string", "enum": ["000", "111", "222", "333", "444", "555", "666", "777", "888", "999"]}
...
TOOL_INPUT_SCHEMAS: Dict[str, Dict[str, Any]] = {
    "init_gate": {
        "type": "object",
        "properties": {
            "query": {"type": "string", "minLength": 1, "description": "User query to initialize session for"},
            "session_id": {"type": "string", "description": "Optional existing session ID"},
            "grounding_required": {"type": "boolean", "default": True, "description": "Whether external grounding is mandatory"},
            "mode": {"type": "string", "enum": ["fluid", "strict"], "default": "fluid", "description": "Governance strictness mode"},
        },
        "required": ["query"]
    },
    ...
    "agi_reason": {
        ...
        "properties": {
            "query": {"type": "string", "minLength": 1},
            "session_id": {"type": "string"},
            "grounding": {"type": ["object", "null"], "description": "Optional structured grounding data"},
        },
        "required": ["query", "session_id"]
    },
    ...
    "vault_seal": {
        ...
        "properties": {
            ...
            "category": {"type": "string", "enum": ["finance", "safety", "content", "code", "governance"]},
        },
    ...
    "vault_query": {
        ...
        "properties": {
            ...
            "verdict": {"type": ["string", "null"], "enum": [None, "SEAL", "VOID", "PARTIAL", "SABAR"]},
