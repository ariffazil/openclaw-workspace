...
Usage:
    from arifosmcp.transport.infrastructure.logging import get_logger, correlation_id
...
mcp_logger = get_logger("arifosmcp.transport")
tool_logger = get_logger("arifosmcp.transport.tools")
floor_logger = get_logger("arifosmcp.transport.floors")
audit_logger = get_logger("arifosmcp.transport.audit")
