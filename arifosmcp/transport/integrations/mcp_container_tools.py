...
from arifosmcp.transport.integrations.container_controller import get_controller
...
def register_container_tools(mcp):
    ...
    async def container_exec(name: str, command: str) -> dict:
        ...
        container_map = {"agentzero": "agentzero-fixed", "qdrant": "qdrant"}
        ...
        try:
            ...
            return {"verdict": "VOID", "error": str(e), "floor_enforced": ["F11"]}
