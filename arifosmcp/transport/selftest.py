...
Usage:
    ...
    python -m arifosmcp.transport.selftest --strict  # Fail on warnings
"""
...
from arifosmcp.transport.protocol.aaa_contract import AAA_TOOL_LAW_BINDINGS, MANIFEST_VERSION
