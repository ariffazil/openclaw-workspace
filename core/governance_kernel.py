...
class GovernanceKernel:
    ...
    # L8: Human Sovereign
    human_approval_status: str = "not_required"  # "not_required" | "pending" | "approved" | "denied"
    ...
    def update_irreversibility(self, impact_scope: float, recovery_cost: float, time_to_reverse: float):
        """
