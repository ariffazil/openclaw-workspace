...
BENCHMARK_CASES = [
    ...
    ("This approach respects all stakeholders and promotes peace", 0.8, 0.6, 0.7, "peaceful_collaborative"),
    ...
    ("Based on the data and research, this function computes results", 0.6, 0.4, 0.9, "grounded_tool"),
...
def run_benchmark() -> Dict[str, Any]:
    ...
    results["overall_accuracy"] = (results["f5_correct"] + results["f6_correct"] + results["f9_correct"]) / (results["total"] * 3)
